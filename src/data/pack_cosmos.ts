...
export const PACK: CosmosObject[] = [
  ...
  { id: 'x-phobos', name: 'Phobos', distanceLy: 2.4e-5, category: 'solarSystem', sub: 'Moons', importance: 4 },
  { id: 'x-deimos', name: 'Deimos', distanceLy: 2.4e-5, category: 'solarSystem', sub: 'Moons', importance: 4 },
  { id: 'x-io', name: 'Io', distanceLy: 8.2e-5, category: 'solarSystem', sub: 'Moons', importance: 3, note: 'The most volcanic world in the solar system, squeezed by Jupiter tides' },
  { id: 'x-europa', name: 'Europa', distanceLy: 8.2e-5, category: 'solarSystem', sub: 'Moons', importance: 2, note: 'An icy shell over a salt-water ocean that may hold more water than Earth' },
  { id: 'x-ganymede', name: 'Ganymede', distanceLy: 8.2e-5, category: 'solarSystem', sub: 'Moons', importance: 3, note: 'The largest moon in the solar system, bigger than the planet Mercury' },
  { id: 'x-callisto', name: 'Callisto', distanceLy: 8.2e-5, category: 'solarSystem', sub: 'Moons', importance: 4 },
  { id: 'x-titan', name: 'Titan', distanceLy: 1.5e-4, category: 'solarSystem', sub: 'Moons', importance: 2, note: 'A moon with a thick atmosphere and lakes of liquid methane' },
  { id: 'x-enceladus', name: 'Enceladus', distanceLy: 1.5e-4, category: 'solarSystem', sub: 'Moons', importance: 3, note: 'Jets of water ice erupt from a hidden ocean at its south pole' },
  { id: 'x-rhea', name: 'Rhea', distanceLy: 1.5e-4, category: 'solarSystem', sub: 'Moons', importance: 4 },
  { id: 'x-iapetus', name: 'Iapetus', distanceLy: 1.5e-4, category: 'solarSystem', sub: 'Moons', importance: 4 },
  { id: 'x-mimas', name: 'Mimas', distanceLy: 1.5e-4, category: 'solarSystem', sub: 'Moons', importance: 4 },
  { id: 'x-titania', name: 'Titania', distanceLy: 3.03e-4, category: 'solarSystem', sub: 'Moons', importance: 4 },
  { id: 'x-oberon', name: 'Oberon', distanceLy: 3.03e-4, category: 'solarSystem', sub: 'Moons', importance: 4 },
  { id: 'x-miranda', name: 'Miranda', distanceLy: 3.03e-4, category: 'solarSystem', sub: 'Moons', importance: 4 },
  { id: 'x-triton', name: 'Triton', distanceLy: 4.74e-4, category: 'solarSystem', sub: 'Moons', importance: 3, note: 'Orbits Neptune backwards, a captured Kuiper belt world with nitrogen geysers' },
  { id: 'x-charon', name: 'Charon', distanceLy: 6.2e-4, category: 'solarSystem', sub: 'Moons', importance: 4, note: 'So large it and Pluto orbit a point in empty space between them' },

  { id: 'x-ceres', name: 'Ceres', distanceLy: 4.3e-5, category: 'solarSystem', sub: 'Dwarf planets', importance: 3, note: 'The only dwarf planet in the asteroid belt, round enough to pull itself into a ball' },
  { id: 'x-vesta', name: 'Vesta', distanceLy: 4.0e-5, category: 'solarSystem', sub: 'Asteroids', importance: 4 },
  { id: 'x-pallas', name: 'Pallas', distanceLy: 4.4e-5, category: 'solarSystem', sub: 'Asteroids', importance: 4 },
  { id: 'x-hygiea', name: 'Hygiea', distanceLy: 5.0e-5, category: 'solarSystem', sub: 'Asteroids', importance: 4 },
  { id: 'x-eros', name: 'Eros', distanceLy: 2.3e-5, category: 'solarSystem', sub: 'Asteroids', importance: 4 },
  { id: 'x-bennu', name: 'Bennu', distanceLy: 1.7e-5, category: 'solarSystem', sub: 'Asteroids', importance: 4, note: 'A rubble-pile asteroid whose sample was returned to Earth in 2023' },
  { id: 'x-orcus', name: 'Orcus', distanceLy: 6.2e-4, category: 'solarSystem', sub: 'Dwarf planets', importance: 4 },
  { id: 'x-quaoar', name: 'Quaoar', distanceLy: 6.8e-4, category: 'solarSystem', sub: 'Dwarf planets', importance: 4 },
  { id: 'x-haumea', name: 'Haumea', distanceLy: 6.8e-4, category: 'solarSystem', sub: 'Dwarf planets', importance: 3, note: 'Spins so fast it is stretched into an egg shape and has its own ring' },
  { id: 'x-makemake', name: 'Makemake', distanceLy: 7.1e-4, category: 'solarSystem', sub: 'Dwarf planets', importance: 3 },
  { id: 'x-gonggong', name: 'Gonggong', distanceLy: 1.05e-3, category: 'solarSystem', sub: 'Dwarf planets', importance: 4 },
  { id: 'x-eris', name: 'Eris', distanceLy: 1.5e-3, category: 'solarSystem', sub: 'Dwarf planets', importance: 2, note: 'The discovery that got Pluto demoted, more massive than Pluto and far further out' },
  { id: 'x-sedna', name: 'Sedna', distanceLy: 1.2e-2, category: 'solarSystem', sub: 'Dwarf planets', importance: 3, note: 'On an orbit so vast a single year lasts over eleven thousand of ours' },

  { id: 'x-halley', name: "Halley's Comet", distanceLy: 2.8e-4, category: 'solarSystem', sub: 'Comets', importance: 3, note: 'Returns every 76 years, last seen in 1986 and due back in 2061' },
  { id: 'x-hale-bopp', name: 'Comet Hale-Bopp', distanceLy: 5.4e-5, category: 'solarSystem', sub: 'Comets', importance: 4, note: 'The great comet of 1997, visible to the naked eye for a record 18 months' },
  { id: 'x-oumuamua', name: "'Oumuamua", distanceLy: 5.0e-4, category: 'solarSystem', sub: 'Comets', importance: 3, note: 'The first known object to visit us from another star system' },

  { id: 'x-iss', name: 'International Space Station', distanceLy: 4.5e-11, category: 'solarSystem', sub: 'Spacecraft', importance: 3, note: 'Orbiting just 400 km up, its light reaches you in a millionth of a second' },
  ...
  { id: 'x-jwst', name: 'James Webb Space Telescope', distanceLy: 1.6e-7, category: 'solarSystem', sub: 'Spacecraft', importance: 3, note: 'Parked 1.5 million km away at the L2 point, watching the first galaxies' },
