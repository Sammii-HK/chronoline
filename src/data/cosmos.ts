...
export const COSMOS: CosmosObject[] = [
  // ===== SOLAR SYSTEM =====
  { id: 'moon', name: 'The Moon', distanceLy: 4.06e-8, category: 'solarSystem', sub: 'Moon', importance: 1, note: 'Light from the Moon reaches us in just over a second' },
  { id: 'sun', name: 'The Sun', distanceLy: 1.58e-5, category: 'solarSystem', sub: 'Structure', importance: 1, note: 'Eight light-minutes away, and it holds 99.8% of the solar system mass' },
  { id: 'mercury', name: 'Mercury', distanceLy: 6.2e-6, category: 'solarSystem', sub: 'Planet', importance: 3 },
  { id: 'venus', name: 'Venus', distanceLy: 1.14e-5, category: 'solarSystem', sub: 'Planet', importance: 3 },
  { id: 'mars', name: 'Mars', distanceLy: 2.4e-5, category: 'solarSystem', sub: 'Planet', importance: 2, note: 'Even at its closest, a radio signal takes about three minutes to reach it' },
  { id: 'asteroid-belt', name: 'Asteroid belt', distanceLy: 4.3e-5, category: 'solarSystem', sub: 'Structure', importance: 3 },
  { id: 'jupiter', name: 'Jupiter', distanceLy: 8.2e-5, category: 'solarSystem', sub: 'Planet', importance: 2, note: 'Big enough to swallow every other planet with room to spare' },
  { id: 'saturn', name: 'Saturn', distanceLy: 1.5e-4, category: 'solarSystem', sub: 'Planet', importance: 2 },
  { id: 'uranus', name: 'Uranus', distanceLy: 3.03e-4, category: 'solarSystem', sub: 'Planet', importance: 3 },
  { id: 'neptune', name: 'Neptune', distanceLy: 4.74e-4, category: 'solarSystem', sub: 'Planet', importance: 2 },
  { id: 'pluto', name: 'Pluto', distanceLy: 6.2e-4, category: 'solarSystem', sub: 'Dwarf planet', importance: 3 },
  { id: 'kuiper-belt', name: 'Kuiper belt', distanceLy: 7.1e-4, category: 'solarSystem', sub: 'Structure', importance: 3 },
  { id: 'voyager-1', name: 'Voyager 1', distanceLy: 2.6e-3, category: 'solarSystem', sub: 'Spacecraft', importance: 2, note: 'The furthest human-made object, still calling home after nearly 50 years' },
  { id: 'oort-cloud', name: 'Oort cloud', distanceLy: 0.79, category: 'solarSystem', sub: 'Structure', importance: 2, note: 'A shell of icy comets nearly a light-year out, the true edge of the Sun grip' },
